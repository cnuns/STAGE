...
class LocalRunner:
    ...
    def __init__(self, snapshot_config, max_cpus=1):
        ...
        self._stats = ExperimentStats(total_itr=1,
                                      total_env_steps=0,
                                      total_epoch=0,
                                      last_path=None)
    ...
    def setup(self, algo, env, sampler_cls=None, sampler_args=None, hybrid_mode=False, devices={}, flag=None,):
    ...
    def log_diagnostics(self, pause_for_plot=False):
        ...
        """
        totalTime = (time.time() - self._start_time)
        logger.log('Time %.2f s' % totalTime)
        tabular.record('TotalTime', totalTime)
    ...
    def step_epochs(self):
        ...
        for epoch in range(self._train_args.start_epoch, n_epochs+1):
